...
update=$(curl -X GET "https://api.cloudflare.com/client/v4/zones/$zone_id/dns_records?type=A&name=$zone_name&content=$current_content&page=1&per_page=20&order=type&direction=desc&match=all" \
